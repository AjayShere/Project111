...
public class TestApplyHomeLoan {
	...
	public void setup() throws ParseException {
		...
		HomeLoan e6 = new HomeLoan(12378, 3, d1, 22000, "ford", "manager", 8, 2, userDetails);
		HomeLoan e7 = new HomeLoan(123, 7, d2, 88000, "hella", "manager", 7, 2, userDetails);
	...
	// @Test
	public void updateHomeLoanDetails() throws ParseException, BankManagementException {
		
		Date d3=new Date(20-12-2017);
		HomeLoan e8 = new HomeLoan(125, 7, d3, 88700, "cogni", "manager", 9, 4, userDetails);
		long loanACCNum = applyHomeLoanService.generateLoanAccNumber();
